...
iree_uk_mmt4d_tile_s8s8s32_1xXXx1_to_7xXXx1_riscv_64_v(
  ...
  if (M0 == 1) {
    if (params->flags & IREE_UK_FLAG_MMT4D_ACCUMULATE) {
      ...
      acc0 = __riscv_vmv_v_x_i32m4(0.0, vl);
    }
    for (int k = 0; k < params->K; ++k) {
      vint8m1_t rhs_s8 = __riscv_vle8_v_i8m1(rhs_ptr, vl);
      vint16m2_t rhs_s16 = __riscv_vwcvt_x_x_v_i16m2(rhs_s8, vl);
      rhs_ptr += N0;

      iree_uk_int16_t lhs0 = (iree_uk_int16_t) * (lhs_ptr)++;

      acc0 = __riscv_vwmacc_vx_i32m4(acc0, lhs0, rhs_s16, vl);
    }
    ...
    if (params->flags & IREE_UK_FLAG_MMT4D_ACCUMULATE) {
      ...
      acc0 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc1 = __riscv_vmv_v_x_i32m4(0.0, vl);
    }
    for (int k = 0; k < params->K; ++k) {
      vint8m1_t rhs_s8 = __riscv_vle8_v_i8m1(rhs_ptr, vl);
      vint16m2_t rhs_s16 = __riscv_vwcvt_x_x_v_i16m2(rhs_s8, vl);
      ...
      acc0 = __riscv_vwmacc_vx_i32m4(acc0, lhs0, rhs_s16, vl);
      acc1 = __riscv_vwmacc_vx_i32m4(acc1, lhs1, rhs_s16, vl);
    }
    __riscv_vse32_v_i32m4(out_ptr, acc0, vl);
    ...
    if (params->flags & IREE_UK_FLAG_MMT4D_ACCUMULATE) {
      ...
      acc0 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc1 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc2 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc3 = __riscv_vmv_v_x_i32m4(0.0, vl);
    }
    for (int k = 0; k < params->K; ++k) {
      vint8m1_t rhs_s8 = __riscv_vle8_v_i8m1(rhs_ptr, vl);
      vint16m2_t rhs_s16 = __riscv_vwcvt_x_x_v_i16m2(rhs_s8, vl);
      ...
      acc0 = __riscv_vwmacc_vx_i32m4(acc0, lhs0, rhs_s16, vl);
      acc1 = __riscv_vwmacc_vx_i32m4(acc1, lhs1, rhs_s16, vl);
      acc2 = __riscv_vwmacc_vx_i32m4(acc2, lhs2, rhs_s16, vl);
      acc3 = __riscv_vwmacc_vx_i32m4(acc3, lhs3, rhs_s16, vl);
    }
    __riscv_vse32_v_i32m4(out_ptr, acc0, vl);
    __riscv_vse32_v_i32m4(out_ptr + N0, acc1, vl);
    ...
    if (params->flags & IREE_UK_FLAG_MMT4D_ACCUMULATE) {
      ...
      acc2 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc3 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc4 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc5 = __riscv_vmv_v_x_i32m4(0.0, vl);
      acc6 = __riscv_vmv_v_x_i32m4(0.0, vl);
    }
    for (int k = 0; k < params->K; ++k) {
      vint8m1_t rhs_s8 = __riscv_vle8_v_i8m1(rhs_ptr, vl);
      vint16m2_t rhs_s16 = __riscv_vwcvt_x_x_v_i16m2(rhs_s8, vl);
      ...
      acc2 = __riscv_vwmacc_vx_i32m4(acc2, lhs2, rhs_s16, vl);
      acc3 = __riscv_vwmacc_vx_i32m4(acc3, lhs3, rhs_s16, vl);
      acc4 = __riscv_vwmacc_vx_i32m4(acc4, lhs4, rhs_s16, vl);
      acc5 = __riscv_vwmacc_vx_i32m4(acc5, lhs5, rhs_s16, vl);
      acc6 = __riscv_vwmacc_vx_i32m4(acc6, lhs6, rhs_s16, vl);
    }
    __riscv_vse32_v_i32m4(out_ptr, acc0, vl);
    __riscv_vse32_v_i32m4(out_ptr + N0, acc1, vl);
    __riscv_vse32_v_i32m4(out_ptr + N0 * 2, acc2, vl);
